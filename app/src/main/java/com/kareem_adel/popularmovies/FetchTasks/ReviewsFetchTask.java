...
public class ReviewsFetchTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            URL url = MovieAPIs.BuildReviewsAPI(APIParam);
            ...
            mContext.getContentResolver().delete(MoviesContract.Reviews.ReviewsUri(), MoviesContract.Reviews.COLUMN_MovieID + " = ?", new String[]{APIParam});
            mContext.getContentResolver().bulkInsert(MoviesContract.Reviews.ReviewsUri(), contentValues);
    ...
    public static ContentValues[] ParseMoviesObject(String ReturnMoviesString, String APIParam) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            contentValue.put(MoviesContract.Reviews.COLUMN_MovieID, APIParam);
            contentValue.put(MoviesContract.Reviews.COLUMN_Author, movieResultJsonObject.getString("author"));
            contentValue.put(MoviesContract.Reviews.COLUMN_Content, movieResultJsonObject.getString("content"));
